...
- Voice input via Gemini multimodal API (speech-to-text)
...
- **Live Demo**: https://trippilot-orpin.vercel.app
- **Code Repository**: https://github.com/ouxiao/trippilot
